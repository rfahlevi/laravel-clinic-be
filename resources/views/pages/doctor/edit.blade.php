    ...
    <div class="main-content">
        <section class="section">
            ...
            <div class="section-body">
                ...
                <form action="{{route('doctors.update', $doctor)}}" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate="">
                    @method('PATCH')
                    @csrf
                    <div class="row">
                        <div class="col-8">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            <div class="custom-file">
                                                ...
                                                <input type="file" name="photo" value="{{$doctor->photo}}" class="custom-file-input @error('photo') is-invalid @enderror" id="inputGroupFile03" aria-describedby="inputGroupFileAddon03">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="specialization" value="{{$doctor->email}}"
